...
const entryCards: EntryCard[] = [
  ...
  },
  {
    kicker: "Timelines",
    title: "Ownerships",
    description: "Manage active owner timelines and transfer unit ownership safely.",
    href: "/ownerships",
    roles: ["SOCIETY_ADMIN", "MANAGER", "READ_ONLY"],
  },
  {
    kicker: "Timelines",
    title: "Residencies",
    description: "Track current and historical unit occupancy with overlap protection.",
    href: "/residencies",
    roles: ["SOCIETY_ADMIN", "MANAGER", "READ_ONLY"],
  },
  {
    kicker: "Contribution Master Data",
    title: "Contribution Periods",
    description: "Review the seeded year and month periods available for contribution posting.",
  ...
  },
  {
    ...
    description: "Manage the charge heads, pay-unit rules, and monthly or yearly charge behavior.",
  ...
  },
  {
    ...
    description: "Append and review rate history without mutating previously posted financial context.",
